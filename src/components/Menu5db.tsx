...
// EPCC (menu5-donut-im-logo-exact-image) - FIX theo yêu cầu người dùng "vẽ
// lại chữ IM sao cho giống ảnh 1 tham chiếu nhất, đừng tự thiết kế riêng
// nhìn không đồng nhất": các bản trước (menu5-donut-center-im-logo,
// menu5-donut-logo-exact-font-color, menu5-donut-logo-industrial-rounded-
// font) đều DỰNG LẠI chữ "iM" bằng <text> + font hệ thống ("VAG Rounded",
// "Eurostile Rounded"...) ghép cùng vài khối rect/circle tự vẽ cho chữ "i".
// NGUYÊN NHÂN gốc của "nhìn không đồng nhất": các font đó hầu như KHÔNG
// được cài sẵn trên máy người dùng/máy build → trình duyệt tự rơi về font
// thay thế có hình dáng khác hẳn (mảnh hơn/béo hơn/góc cạnh khác), có thể
// khác nhau giữa các máy dù chạy cùng 1 đoạn code — cộng với phần "M" tự vẽ
// tay không thể khớp 100% nét chữ thật của logo gốc.
// SỬA TẬN GỐC: không dựng lại chữ bằng font/hình khối nữa — nhúng THẲNG
// ảnh logo gốc do người dùng cung cấp (ảnh tham chiếu) dưới dạng base64,
// vẽ bằng <image> ngay trong SVG. Ảnh gốc (nền trắng) đã được xử lý thành
// PNG NỀN TRONG SUỐT (tách nền trắng ra khỏi đúng màu navy đặc trưng của
// logo bằng phép "khử nền" theo tỉ lệ pha màu, giữ nguyên viền/nét chữ mượt
// răng cưa - anti-alias) để ghép lên được cả nền sáng lẫn nền tối mà không
// lộ khung trắng hình chữ nhật. Vì là ẢNH THẬT (không phải font/tự vẽ),
...
const IM_LOGO_DATA_URI =
  'data:image/png;base64,';
// Tỉ lệ khung ảnh gốc (rộng x cao) — dùng để giữ đúng tỉ lệ khi co giãn
// logo theo bán kính `r` của donut, tránh méo hình.
...
function DonutCenterLogo({ cx, cy, r, theme }: { cx: number; cy: number; r: number; theme: ThemeMode }) {
  ...
  return (
    <g>
      {/* Nền tròn phía sau logo — trắng ở theme light, xám xanh rất tối ở
          theme dark để logo (nền đã trong suốt) vẫn nổi rõ trên nền dashboard
          tối, đồng bộ với cách các donut khác xử lý nền tâm. */}
      <circle cx={cx} cy={cy} r={r} fill={theme === 'light' ? '#ffffff' : '#101826'} />
      <image
        href={IM_LOGO_DATA_URI}
        x={cx - logoW / 2}
        y={cy - logoH / 2}
        width={logoW}
        height={logoH}
